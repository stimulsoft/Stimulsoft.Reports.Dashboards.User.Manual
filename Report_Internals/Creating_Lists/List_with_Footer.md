...
The **Data** band may have an unlimited number of bands. Bands of totals will be output in the same order as they are placed on a page.


* **Note:** For one Data band unlimited number of Footer bands can be created.
