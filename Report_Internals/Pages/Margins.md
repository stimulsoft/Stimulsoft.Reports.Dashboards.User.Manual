...
> **Information**
>
> Borders in the created report are not displayed. The page consists of the print area and margins.
...
> **Important**
>
> The units of the fields correspond to the units of the report, such as centimeters, millimeters, inches, or hundredths of inches.
...
> **Information**
>
> If the margins have the same values (right margin is equal to the left), their mirrored margins will be the same.
...
> **Information**
>
> In some types of interfaces, the Page tab may be missing. In such cases, only one default margin size is set, and no other preset fields are available.
...
> **Important**
>
> The minimum size of margins depends on the printer used, the printer driver, and the paper size. For information regarding the minimum size of margins, please refer to the user manual of your printer.
