...
![](../../images/img_2.png) The **Color Scale Type** field provides an opportunity to choose the type of color scheme: 2-color scales, or 3-color scales. The picture below shows the menu to select the type of a color scale:
