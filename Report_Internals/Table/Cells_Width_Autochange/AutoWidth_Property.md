...
* The **AutoWidth** property is set to **None**. Column size is not changed. In this case setting the **AutoWidthType** property of a table and the **FixedWidth** property of cells will not affect a table.
