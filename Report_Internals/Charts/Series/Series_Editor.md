...
* Using the **Width** property it is possible to change the width of the created values. The default value is 0, meaning the title width is limited by the chart area.
