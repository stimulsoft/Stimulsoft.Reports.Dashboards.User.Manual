...
As can be seen from the picture above, the template page will be rendered with the main data. To display the detailed data, click the rendered text component. The report generator will run the report and render it, considering the parameters of the detailing and filtering. The picture below shows schematically the report:
