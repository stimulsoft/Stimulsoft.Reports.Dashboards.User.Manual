...
As can be seen from the picture above, a report can be interpreted as reports **B1** and **B2**. This is the first level of detailing. Reports **B1** and **B2**, in turn, have detailing as reports **C1**, **C2**, **C3** and **C4**. This is a detailing of the second level. Consider the creation of drill-down reports in more detail.
