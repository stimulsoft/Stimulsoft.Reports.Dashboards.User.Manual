...
The **FooterBand** is placed below the **DataBand**. And it is meant that the **DataBand**, with what the **HeaderBand** is bound. Each **FooterBand** refers to any specific **HeaderBand**. Without the **HeaderBand**, the **FooterBand** is not output.


![](../../images/topics/Report_Internals.Creating_Master-Detail_lists.Headers_Footers_and_MasterDetail_Reports_1.png)


The picture above shows a structure of a **Master-Detail** report with two **DataBand** bands**.**
