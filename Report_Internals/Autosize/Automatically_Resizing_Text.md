...
* **Note:** If the **AutoWidth** property is set to false then the height of the text depends on the **CanGrow** and **CanShrink** properties. If the **AutoWidth**  property is set to false then it will change the width of the text.
