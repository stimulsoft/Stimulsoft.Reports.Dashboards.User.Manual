...
In this case, free space available remained on the first page of the report, because the band could not fit entirely and was moved by the report engine to the next page. If to set the **CanBreak** property to **true**, then this will be "broken". The picture below shows how the third band is broken.
