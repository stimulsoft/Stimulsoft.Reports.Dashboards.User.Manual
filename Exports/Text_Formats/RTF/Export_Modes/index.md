...
* **WinWord** - similar to Frames, but all the objects are passed as "frame" objects of MS-Word.

* **TabbedText** - the same as the export to the Text format, the position of a text is set using blank spaces and tabulations.
