...
* UnicodeSingle - drawing a border using the symbols of  pseudographics; symbols of a solid border are used;

* UnicodeDouble - drawing a border using  the symbols of  pseudographics; symbols of a double border are used.
