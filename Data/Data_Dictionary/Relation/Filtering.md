...
where Products is a data source name; RelationName is a name of the relation between data sources, i.e. reference to another data source via the relation; CategoryName is a data column in the data source.
