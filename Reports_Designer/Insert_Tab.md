...
![](../images/img_1.png) A command that creates a new report page in the template.

![](../images/img_2.png) A command that creates a [dashboard](../Dashboards/index.md) in the template.

![](../images/img_3.png) A command that creates a new dialog form in the template.
