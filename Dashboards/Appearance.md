...
When creating dashboards for a watermark you can specify:


* [Text](#watermarktext) which will be displayed in a dashboard.

* [Image](#watermarkimage), which will fill the image background
...
> **Information**
>
> When creating a watermark for a dashboard, you can use various combinations of watermark modes. For example, image and text or text and weave or all of them.
...
![](../images/img_2.png) The **Text** parameter allows you to define the text which will be displayed as a watermark;
...
You can specify an image as a watermark. The parameters of this watermark type are placed on the corresponding tab in the watermark editor.
...
![](../images/img_2.png) The field of image loading, which will be a watermark for the dashboard.
